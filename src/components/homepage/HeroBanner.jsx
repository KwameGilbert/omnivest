...
const HeroBanner = () => {
  ...
  return (
    <section className="relative bg-[#111827] text-[#f3f4f6] min-h-[90vh] flex items-center overflow-hidden font-['Inter']">
      {/* Background Video */}
        ...
        {(() => {
          ...
          return (
            <div
              ...
              style={{
                background: `linear-gradient(135deg, rgba(${overlayColor},${overlayOpacity + 0.1}) 0%, rgba(${overlayColor},${overlayOpacity}) 50%, rgba(${overlayColor},${overlayOpacity + 0.05}) 100%)`,
                mixBlendMode: 'normal'
              }}
            ></div>
          );
     ...
     {/* Content Section */}
      <div className="container mx-auto px-4 relative z-10 py-12 text-center">
        <motion.div
          ...
          style={{ color: '#fff', textShadow: '0 2px 8px rgba(0,0,0,0.5), 0 1px 3px rgba(0,0,0,0.3)' }}
        >
          {/* Dynamic Heading with Gradient */}
            ...
            className="text-4xl lg:text-5xl font-bold leading-tight h-[8.5rem] lg:h-[5.0rem]"
            >
            <span ref={typedRef} className="text-white font-bold"></span>
            </motion.h1>
          ...
          <motion.p
            ...
            className="text-md md:text-lg text-white font-medium leading-relaxed max-w-2xl mx-auto"
          >
          ...
          <motion.div
            ...
            className="flex flex-col sm:flex-row justify-center gap-4 pt-5"
          >
            ...
            <motion.div
              ...
              whileTap={{ scale: 0.95 }}
              className="bg-[#f59e0b] text-[#fff] px-8 py-3 rounded-lg font-semibold flex items-center justify-center gap-2 transition-all hover:bg-[#e68a00] hover:text-[#eee] border-2 border-[#f59e0b]"
            >
            ...
            <motion.div
              ...
              whileTap={{ scale: 0.95 }}
              className="border-2 border-[#eee] bg-transparent text-[#fff] px-8 py-3 rounded-lg font-semibold flex items-center justify-center gap-2 hover:bg-[#f59e0b] hover:text-[#eee] hover:border-[#f59e0b] transition-all"
            >
